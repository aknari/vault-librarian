...
2. Propose    note ──▶ summary + tags + related          (LLM; batched or hand-picked)
...
**prompt or the model** changed, because then it answers a question nobody is
asking any more — `proposals.json` records both.
